...
void LMotorController::move(int speed, int minAbsSpeed, double motorAConst, double motorBConst)
{
    int direction = 1;
    ...
    digitalWrite(_in3, speed > 0 ? HIGH : LOW);
    digitalWrite(_in4, speed > 0 ? LOW : HIGH);
    analogWrite(_ena, realSpeed * motorAConst);
    analogWrite(_enb, realSpeed * motorBConst);
